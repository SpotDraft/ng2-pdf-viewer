...
export declare class NgxVarDirective<T = unknown> implements OnInit {
    private _vcr;
    private _templateRef;
    private _context;
    set ngxVar(value: T);
    constructor(_vcr: ViewContainerRef, _templateRef: TemplateRef<Context<T>>);
    ngOnInit(): void;
    /**
     ...
     */
    static ngTemplateContextGuard<T>(dir: NgxVarDirective<T>, ctx: any): ctx is Context<Exclude<T, false | 0 | '' | null | undefined>>;
    static ɵfac: i0.ɵɵFactoryDeclaration<NgxVarDirective<any>, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxVarDirective<any>, "[ngxVar]", never, { "ngxVar": "ngxVar"; }, {}, never>;
}
